...
private static final Logger logger = Logger.getLogger(TaskDao.class);
	...
	/*public static List<TaskInfo> selectAlltasks(String room)
	{
		sql = "select * from mastertask where room = ?";
		List<TaskInfo> taskList2 = jdbcTemplate.query(sql,new Object[]{room}, new TaskRowMapper());
		logger.debug("tasklist" +taskList2);
		return taskList2;
	}*/
